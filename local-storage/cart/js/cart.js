...
getData(`https://neto-api.herokuapp.com/cart/colors`)
    ...
    .then(res => colorSwatch.addEventListener(`click`, onCheckbox));

getData(`https://neto-api.herokuapp.com/cart/sizes`)
    .then(res => setSize(res))
    .then(res => sizeSwatch.addEventListener(`click`, onCheckbox));
...
function setColor(colors) {
    colors.forEach(color => {
        ...
        colorSwatch.appendChild(createColorElement(color.title, color.type, color.code, color.isAvailable, isCurrent));
    });
}
...
function setSize(sizes) {
    sizes.forEach(size => {
        ...
        sizeSwatch.appendChild(createSizeElement(size.title, size.type, size.isAvailable, isCurrent));
    });
}